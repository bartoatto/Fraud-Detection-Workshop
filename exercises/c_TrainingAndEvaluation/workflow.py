...
def credit_card_fraud_detection_workflow():
    ...
    ada_training_task = DominoJobTask(
        ...
        domino_job_config=DominoJobConfig(Command="python exercises/c_TrainingAndEvaluation/trainer_ada.py"),
    ...
    gnb_training_task = DominoJobTask(
        ...
        domino_job_config=DominoJobConfig(Command="python exercises/c_TrainingAndEvaluation/trainer_gnb.py"),
        inputs={'transformed_filename': str},
        outputs={'results': str},
        use_latest=True,
        cache=True
    ...
    xgb_training_task = DominoJobTask(
        ...
        domino_job_config=DominoJobConfig(Command="python exercises/c_TrainingAndEvaluation/trainer_xgb.py"),
        inputs={'transformed_filename': str},
        outputs={'results': str},
        use_latest=True,
        cache=True
    ...
    compare_task = DominoJobTask(
        ...
        domino_job_config=DominoJobConfig(Command="python exercises/c_TrainingAndEvaluation/compare.py"),
